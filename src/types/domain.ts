...
export interface Lot {
  ...
  title: string
  description: string
  selection: 'anbieten' | 'nicht_anbieten' | 'unklar'
...
export interface Risk {
  ...
  description: string
  action: string
  status: 'offen' | 'bestaetigt' | 'erledigt'
  evidence: Evidence[]
}
...
export interface License {
  status: 'trial' | 'active' | 'lifetime' | 'inactive' | 'past_due' | 'blocked' | 'cancelled' | 'expired'
